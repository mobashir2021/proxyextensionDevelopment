...
//script.dataset.mode =  'random';
script.dataset.once = true; // only manipulate once
window.rnd = window.rnd || {
  r: Math.floor(Math.random() * 100) - Math.floor(Math.random() * 10),
  g: Math.floor(Math.random() * 100) - Math.floor(Math.random() * 10),
  b: Math.floor(Math.random() * 100) - Math.floor(Math.random() * 10)
};
...
script.textContent = `{
  ...
  HTMLCanvasElement.prototype.manipulate = function() {
    ...
    const shift = {
      'r': script.dataset.mode === 'random' ? Math.floor(Math.random() * 100) - Math.floor(Math.random() * 10) : Number(script.dataset.red),
      'g': script.dataset.mode === 'random' ? Math.floor(Math.random() * 100) - Math.floor(Math.random() * 10) : Number(script.dataset.green),
      'b': script.dataset.mode === 'random' ? Math.floor(Math.random() * 100) - Math.floor(Math.random() * 10) : Number(script.dataset.blue)
    };
